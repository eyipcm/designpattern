package com.aypc.behavioral.interpreter;
...
public class InterpreterDemo {
	public static com.aypc.behavioral.interpreter.b4.InterpreterDemo interpreter = new com.aypc.behavioral.interpreter.b4.InterpreterDemo();
